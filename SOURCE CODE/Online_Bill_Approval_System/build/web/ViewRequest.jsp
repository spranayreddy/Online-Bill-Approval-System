    ...
    <body>
        ...
        <div id="left">
           ...
           <table>
               ...
               ResultSet r=st.executeQuery("select * from letter where status='waiting'");
               while(r.next()){
               ...
               <tr>
                   ...
                   <td><a href="image1.jsp?id=<%=r.getString("id")%>"><image src="view.jsp?id=<%=r.getString("id")%>" width="100" height="100"/></a></td>
              
                   <%if(status.equals("waiting")){
                   %>
                 <td><a href="Accept.jsp?id=<%=r.getString("id")%>&email=<%=r.getString("email")%>&amount=<%=r.getString("amount")%>">waiting</a></td>
               <%
               }else{%>
